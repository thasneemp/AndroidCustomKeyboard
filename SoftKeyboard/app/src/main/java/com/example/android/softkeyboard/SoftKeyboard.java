...
public class SoftKeyboard extends InputMethodService implements
    ...
    private OutLineViewManager outLineViewManager;
    ...
    public View onCreateInputView() {
        ...
        vIewGroup = (ViewGroup) getLayoutInflater().inflate(
                R.layout.test, null);

        vIewGroup.addView(mInputView);
        outLineViewManager = new OutLineViewManager(this, vIewGroup);
    ...
    public View onCreateCandidatesView() {
        ...
        if (vIewGroup != null) {
            mCandidateView.setOnCharcterListener(outLineViewManager);
        }
    ...
    public void onKey(int primaryCode, int[] keyCodes) {
        ...
        Log.d("Key Pressed", keypress + "   " + primaryCode);
//
